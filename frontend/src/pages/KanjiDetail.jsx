...
import KanjiDrawing from "../components/Kanji/KanjiDrawing.jsx";
import ReadingSection from "../components/Kanji/ReadingSection.jsx";
import { getFontSizeClass } from "../components/Other/SettingMenu.jsx";
import HanVietSection from "../components/Kanji/HanVietSection.jsx";
import RadicalSection from "../components/Kanji/RadicalSection.jsx";
import HelpModal from "../components/Other/HelpModal.jsx";
import TreeSection from "../components/Kanji/TreeSection.jsx";
  ...
  <div className="flex flex-col gap-y-3 w-full mx-auto">
    ...
    <div className="flex gap-3">
      ...
      <div className="w-1/3">
          ...
          <p className={`${getFontSizeClass(setting.fontSize, "medium")} mb-2 mt-4 font-bold text-gray-700 text-center`}>CASCADING KANJI VIEW</p>
          <div className="rounded-2xl bg-white/50 backdrop-blur-md shadow-lg p-2">
