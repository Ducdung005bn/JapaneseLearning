...
import FillIn from "../components/Lesson/FillIn";
import Flashcard from "../components/Lesson/Flashcard";
import MultipleChoice from "../components/Lesson/MultipleChoice";
import Match from "../components/Lesson/Match";
      ...
      <div className="mb-6">
        ...
        <div className={`mt-2 flex justify-end gap-3 ${getFontSizeClass(setting.fontSize, "medium")}`}>
          ...
          <button
            ...
            onClick={() => navigate(`/lesson/${lessonId}/start/quiz`)}
          >
            Start Quiz
          </button>
          <button
      ...
      {lesson.questions.map((q) => {
        ...
        return (
          ...
          >
            ...
            {/* Question Body */}
            {q.type === "fill-in" && <FillIn q={q} showAnswer={showAnswer} setting={setting} />}
            {q.type === "flashcard" && <Flashcard q={q} showAnswer={showAnswer} setting={setting} />}
            {q.type === "multiple-choice" && <MultipleChoice q={q} showAnswer={showAnswer} setting={setting} />}
            {q.type === "match" && <Match q={q} showAnswer={showAnswer} setting={setting} />}
            {q.type === "drag-drop" && <DragDrop q={q} showAnswer={showAnswer} setting={setting} />}
