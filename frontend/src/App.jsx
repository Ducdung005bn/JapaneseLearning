...
export default function App() {
  ...
  const PAGES = [
    ...
    { key: "Vocabulary", icon: BookOpenText, path: "/vocabulary", element: <Vocabulary setting={setting}/> },
          ...
          <div className="mx-auto max-w-7xl px-3 sm:px-6 lg:px-8 h-14 flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <h1 className="text-sm uppercase tracking-widest text-slate-600">STUDY SUITE</h1>
              </div>
            </div>
            ...
            >
              ...
              {picture ? (
                ...
                <button
                  ...
                  className={`px-3 py-2 flex items-center gap-1 bg-red-200 hover:bg-red-400 text-black rounded-2xl transition-colors duration-200 ${getFontSizeClass(setting.fontSize, "medium")}`}
                >
          ...
          <div className={`grid grid-cols-1 md:gap-3 ${sidebarOpen ? "md:grid-cols-[auto,1fr]" : "md:grid-cols-1"} gap-2`}>
            ...
            <AnimatePresence initial={false}>
              {sidebarOpen && (
                ...
                >
                  <div
                    className={`w-full ${getFontSizeClass(setting.fontSize, "medium")} md:w-56 rounded-3xl border border-slate-200/60 bg-slate-50/70 backdrop-blur-xl shadow-xl shadow-slate-300/20`}
                  >
            ...
            <div className="w-full min-w-0">
              <Routes>
                ...
                <Route path="lesson/:lessonId/start/quiz" element={<Quiz setting={setting} />} />
